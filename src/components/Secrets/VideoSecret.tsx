...
export const VideoSecret: React.FC<ISecretComponentProps> = ({ id, title, availableAt, url, createdAt, countdownHandler }) => {
  ...
  return (
    <Card sx={{ maxWidth: '30%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }} elevation={4}>
      <CardActionArea component={RouterLink} to={`../secret/${id}`}>
        ...
        />
        <CardMedia src={SERVER_URL + url} component='video' height={100} />
