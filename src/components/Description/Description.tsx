...
export const Description = () => {
  return (
    <AppBlock>
      ...
      <Typography sx={{display: 'inline-block', width: '49%'}}>Have you ever wished for a place on the web where
      ...
      <Typography sx={{display: 'inline-block', width: '49%', marginLeft: '2%'}}>With a sophisticated, password-protected
